...
extension NSTouchBarItemIdentifier {
    ...
    static let navigation = NSTouchBarItemIdentifier("com.diversium.project4.navigation")
    static let enterAddress = NSTouchBarItemIdentifier("com.diversium.project4.enterAddress")
    static let sharingPicker = NSTouchBarItemIdentifier("com.diversium.project4.sharingPicker")
    static let adjustGrid = NSTouchBarItemIdentifier("com.diversium.project4.adjustGrid")
    static let adjustRows = NSTouchBarItemIdentifier("com.diversium.project4.adjustRows")
    static let adjustCols = NSTouchBarItemIdentifier("com.diversium.project4.adjustCols")
...
class ViewController: NSViewController, WKNavigationDelegate, NSGestureRecognizerDelegate, NSTouchBarDelegate, NSSharingServicePickerTouchBarItemDelegate {
    ...
    @IBAction func urlEntered(_ sender: NSTextField) {
        ...
        // attempt to conver the user's text into a URL
    ...
    @IBAction func adjustRows(_ sender: NSSegmentedControl) {
        ...
        if sender.selectedSegment == 0 {
            ...
            //make sure we have at leasy two rows
    ...
    func makeWebView() -> NSView {
        ...
        webView.load(URLRequest(url: URL(string: "http://accentpos.com")!))
...
//        webView.addGestureRecognizer(recognizer)
    ...
    func select(webView: WKWebView) {
        ...
        if let WindowController = view.window?.windowController as? WindowController {
            ...
            WindowController.enterAddressTF.stringValue = selectedWebView.url?.absoluteString ?? ""
        }
    ...
    func touchBar(_ touchBar: NSTouchBar, makeItemForIdentifier identifier: NSTouchBarItemIdentifier) -> NSTouchBarItem? {
        ...
        case NSTouchBarItemIdentifier.adjustCols:
            ...
            let customTouchBarItem = NSCustomTouchBarItem(identifier: identifier)
            customTouchBarItem.customizationLabel = "Colums"
            customTouchBarItem.view = control
    ...
    override func makeTouchBar() -> NSTouchBar? {
        ...
        touchBar.customizationIdentifier = NSTouchBarCustomizationIdentifier("com.diversium.project4")
        ...
        // but dont let the take off the URL entry button
    ...
    func selectedAddressEntry() {
        ...
        if let windowController = view.window?.windowController as? WindowController {
            ...
            windowController.window?.makeFirstResponder(windowController.enterAddressTF)
